...
import com.example.api.cucumber.dtos.LogMessage
import com.example.api.presentation.controllers.UserController
...
class LoggingStepDefs {
    ...
    @Before
    fun setup() {
        userControllerLogger = LoggerFactory.getLogger(UserController::class.java) as Logger
